...
export default function Home() {
  ...
  return (
    <div className="relative flex flex-col md:flex-row items-center justify-center text-white bg-black min-h-screen px-6 md:px-12 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 ml-16 h-full flex flex-col justify-center p-16 text-white z-10">
        ...
        <button 
          ...
          className="bg-white text-blue-600 ml-2 w-80 px-8 py-4 rounded-full font-semibold text-lg hover:bg-blue-100"
        >
          Start Exploring
        </button>
      </div>
    ...
    {/* Bitcoin Floating */}
      ...
      <img src="/bit.png" alt="Background" className="absolute bottom-0 right-0 w-1/2 h-2/3 object-cover animate-float-slow" />
